    ...
    <div className="relative mt-5">
      ...
      {open && (
        <div className="absolute left-0 right-0 bottom-full z-20 mb-2 grid gap-2 border-2 border-[#111118] bg-[#fffefa] p-3 shadow-[5px_5px_0_#111118]">
          <a href={`${SITE.MAX_URL}?text=${message}`} target="_blank" rel="noopener noreferrer" className="btn-brand !shadow-none">Написать в MAX</a>
          <a href={`${SITE.TELEGRAM_URL}?text=${message}`} target="_blank" rel="noopener noreferrer" className="btn-outline">Написать в Telegram</a>
