...
const ROOM_PRESETS = [
  ...
  ["Комната 6", "Пространство для кино, приставки и отдыха в своей компании.", 2, 6, 3],
  ["Комната 7", "Большая комната с несколькими зонами для праздников и компаний.", 2, 5, 5],
