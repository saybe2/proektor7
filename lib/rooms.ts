...
const ROOM_PRESETS: RoomPreset[] = [
  ...
  { name: "Комната 6", description: "Пространство для кино, приставки и отдыха в своей компании.", minCapacity: 2, capacity: 6, imageCount: 3 },
  { name: "Комната 7", description: "Большая комната с несколькими зонами для праздников и компаний.", minCapacity: 2, capacity: 5, imageCount: 5 },
