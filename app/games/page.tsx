...
export const metadata: Metadata = {
  ...
  description:
    "Более 100 настольных игр в тайм-кафе Proектор: Мафия, Уно, Монополия, Имаджинариум и другие. Играй сколько хочешь!",
};
...
export default async function GamesPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 md:py-12">
      ...
      <p className="text-center text-[#3c3c6e] mb-8 md:mb-10 max-w-2xl mx-auto text-sm md:text-base">
      ...
      <div className="grid gap-3 md:gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {games.map((game) => (
          <div key={game.id} className="card p-4 md:p-5">
            <div className="font-extrabold text-brand-dark">{game.name}</div>
            {game.players && (
              <div className="text-xs font-bold text-brand mt-0.5 flex items-center gap-1">
